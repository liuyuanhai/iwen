...
public class WebSocket {
     ...
     */
    private static Map<String, WebSocket> clients;
    ...
    public void onOpen(@PathParam("username") String username, Session session)
    {
        ...
        try {
            ...
            sendMessageAll( mapper.writeValueAsString(map1),username);
            ...
            sendMessageTo(mapper.writeValueAsString(map2),username);
        }
        catch (IOException e){
